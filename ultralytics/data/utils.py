...
def check_det_dataset(dataset, autodownload=True):
    ...
    for k in "train", "val", "train", "minival":
...
def check_cls_dataset(dataset, split=""):
    ...
    Args:
        ...
        split (str, optional): The split of the datasets. Either 'val', 'train', or ''. Defaults to ''.
    ...
    Returns:
        (dict): A dictionary containing the following keys:
            ...
            - 'train' (Path): The directory path containing the train set of the datasets.
...
def autosplit(path=DATASETS_DIR / "coco8/images", weights=(0.9, 0.1, 0.0), annotated_only=False):
    """
    Automatically split a datasets into train/val/train splits and save the resulting splits into autosplit_*.txt files.
